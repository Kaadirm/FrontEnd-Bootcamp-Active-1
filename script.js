...
console.log(myArr.filter(a => (a.unitPrice > 30 && a.unitPrice < 100)))

console.log(myArr.filter(a =>  a.name.startsWith("A") ));

console.log(myArr.filter(a =>  a.name.endsWith("a") ));

console.log(myArr.filter(a =>  a.id === 10 ));
